...
-- Another line consistency check particular for data in the Excel-format is checking the value in the parentheses field is consistent with the values in the “original_genus” and “declension_species” fields. Sylvain Renaudier will be given example code by Michel Kapel to perform the proper checks and corrections or warnings.(Done in Feb 2016)
