...
-- Another line consistency check particular for data in the Excel-format is checking whether the “original_genus” is provided when the parentheses flag is set to “yes” and/or if “declension_species” is given. As we now also aim to store the parenthesis flag, this check should also be done in the other direction, i.e. verify whether parentheses flag is set to “yes” if a “declension_species” or “original_genus” (different from the “genus”) is provided.
