-- Table: importandsyncfada.taxa_table

-- DROP TABLE importandsyncfada.taxa_table;

CREATE TABLE importandsyncfada.taxa_table
(
  id serial NOT NULL,
  ...
  syn_original_genus character varying(50),
...
ALTER TABLE importandsyncfada.taxa_table
