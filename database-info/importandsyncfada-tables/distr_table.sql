-- Table: importandsyncfada.distr_table

-- DROP TABLE importandsyncfada.distr_table;

CREATE TABLE importandsyncfada.distr_table
(
  id serial NOT NULL,
...
ALTER TABLE importandsyncfada.distr_table
